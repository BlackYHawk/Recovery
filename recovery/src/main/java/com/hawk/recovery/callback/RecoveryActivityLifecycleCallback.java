...
import com.hawk.recovery.core.RecoveryService;
import com.hawk.recovery.core.RecoveryStore;
import com.hawk.recovery.tools.Reflect;
...
public class RecoveryActivityLifecycleCallback implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(final Activity activity, Bundle savedInstanceState) {
        ...
        if (!isLegal)
            return;
        if (activity.getIntent().getBooleanExtra(RecoveryService.RECOVERY_MODE_ACTIVE, false)) {
